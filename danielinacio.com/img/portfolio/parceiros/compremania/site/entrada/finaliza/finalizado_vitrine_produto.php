<?php
  ...
  $assunto = 'CAD LOJA - Vitrine de PRODUTOS - Empresarial - '. $razao_social = $_POST["razao_social"];
  ...
  $mensagem .= "<br><strong>CNPJ:  </strong>".$_POST["ssn"];
...
<div class="row-fluid"> 
  ...
  <div class="widget  span12 clearfix">
    <div class="widget-header"> <span><i class="icon-list-alt"></i>Cadastro efetuado com sucesso.</span> </div>
    <!-- End widget-header -->
...
action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <input name="itemDescription1" type="hidden" value="Plano - Vitrine de Produtos">  
        <input name="itemAmount1" type="hidden" value="19.90">  
...
src="../images/pagueseguro_compremania.png"/>  
         ...
         <form>
              ...
              <input type="text" value="<?php echo $cnpj; ?>" style="color: #970000 !important;"disabled/> 
