<?php
  ...
  $assunto = 'CAD LOJA - LOJA VIRTUAL - Empresarial - '. $razao_social = $_POST["razao_social"];
...
<input type="hidden" name="encoding" value="UTF-8">  
        ...
        <input name="itemDescription1" type="hidden" value="Plano - Loja Virtual">  
        <input name="itemAmount1" type="hidden" value="29.90">  
