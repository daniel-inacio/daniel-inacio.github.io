...
jQuery(document).ready(function($)
{
    ...
    if (ie8up())
    {
        directionsHTML = '<div id="map-overlay" class="overlay"><div id="map-big">&nbsp;</div><div class="directions-form clearfix"><ul class="clearfix"><li class="first-child"><div class="dir-label">De:</div> <input type="text" id="from-input"/> </li><li><div class="dir-label">Sede da CompreMania:</div><input type="text" id="to-input"/> </li></ul><div class="filters clearfix"><select id="travel-mode-input"><option selected="selected" value="driving">De carro</option><option value="bicycling">Bicicleta</option><option value="walking">Caminhando</option></select><select id="unit-input"><option selected="selected" value="imperial">Mais curto</option><option value="metric">Mais Rápido</option></select> <input id="get-directions" type="button" value="Fazer trajeto"/><div class="clear">&nbsp;</div></div></div><div id="dir-container"></div></div>';
    ...
    if (ie8up())
    {
        var googleMap = function(mapOptions)
        {
            ...
            var myOptions = {
                ...
                companyAddress: 'Rua General Carneiro, 2367, Centro, Franca  SP Brasil',
                mapId:"map"
            };
        ...
        var googleDirections = {
            ...
            showDirections: function(dirResult, dirStatus)
            {
                ...
                {
                    alert('Sem endereço de partida, insira um endereço de onde você esta');
                    return;
                }
