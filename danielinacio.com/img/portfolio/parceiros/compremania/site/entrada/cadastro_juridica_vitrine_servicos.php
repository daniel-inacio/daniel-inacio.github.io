...
<li> <a href="#" title="Mostrar todos os Planos"> <img src="images/icon/shortcut/home.png" alt="home" /><strong>Planos</strong> </a> </li>
  ...
  <div class="row-fluid"> 
    ...
    <div class="widget  span12 clearfix">
      ...
      <form  name="digitador" method="post" action="finaliza/finalizado_vitrine_servico.php" />
        ...
        <div id="wizard" class="swMain">
          ...
          <div id="step-1" style=" padding-left:33%;">
           ...
           <option value="Virtine de Serviços - Empresa" selected>Virtine de Serviços - Empresa</option>
           <option value="Vitrine de Produtos - Empresa">Vitrine de Produtos - Empresa</option>
