...
<script src="cep/gmaps.js" type="text/javascript"></script>
...
<li> <a href="#" title="Mostrar todos os Planos"> <img src="images/icon/shortcut/home.png" alt="home" /><strong>Planos</strong> </a> </li>
  ...
  <div class="row-fluid"> 
    ...
    <div class="widget  span12 clearfix">
      ...
      <form  name="digitador" method="post" action="finaliza/finalizado_vitrine_servico_pessoa_fisica.php" />
        ...
        <div id="wizard" class="swMain">
          ...
          <div id="step-1" style=" padding-left:33%;">
		   ...
		   <option value="Virtine de Serviços - Pessoa Física" selected>Virtine de Serviços - Pessoa Física</option>
           <option value="Vitrine de Produtos - Pessoa Física" >Vitrine de Produtos - Pessoa Física</option>
           </select>
           ...
           <option value="Vitrine de Serviços - R$9,90/mês" selected  >Vitrine de Serviços - R$9,90/mês</option>
<option value="Vitrine de Produtos - R$19,90/mês"  >Vitrine de Produtos - R$19,90/mês</option>
<option value="Vitrine de Produtos - R$29,90/mês">Loja Virtual - R$29,90/mês</option>
          ...
          <!-- <h3>Forma de Pagamento:</h3>
           <select class="chzn-select" name="forma_pagamento" id="forma_pagamento">
            ...
            <input type="text" class="full" name="razao_social" id="razao_social" title="teste"  onKeyUp="repeat2(document.digitador.razao_social.value)" />
           
            <br>
            <h3>Responsável:</h3>
            <input type="text" class="full" name="responsavel" id="responsavel"  onKeyUp="repeat3(document.digitador.responsavel.value)" />
            <br />
          </div>
          <div id="step-2" style="padding-left:15%;">
            <div class="span4">
              <h4>CPF:<small> *</small></h4>
              <input type="text" name="cpf"  id="cpf"  onKeyUp="repeat4(document.digitador.ssn.value)"  />
              ...
              <input id="cep" name="cep"  maxlength="9"type="text"  tabindex="3" onKeyUp="repeat7(document.digitador.cep.value)"  />
            </div>
            <div class="span4">
            ...
            <div class="span4">
              ...
              <input type="text" name="celular" id="celular"  maxlength="13" />
              </form>
            </div>
          </div>
          <div id="step-3">
