...
<li> <a href="#" title="Mostrar todos os Planos"> <img src="images/icon/shortcut/home.png" alt="home" /><strong>Planos</strong> </a> </li>
  ...
  <div class="row-fluid"> 
    ...
    <div class="widget  span12 clearfix">
      ...
      <form  name="digitador" method="post" action="finaliza/finalizado_loja_virtual.php" />
        ...
        <div id="wizard" class="swMain">
          ...
          <div id="step-1" style=" padding-left:33%;">
           ...
           <option value="Loja Virtual - Empresa"  selected>Loja Virtual - Empresa</option>
           </select>
...
<option value="Vitrine de Produtos - R$29,90/mês" selected>Loja Virtual - R$29,90/mês</option>
