...
<li> <a href="#" title="Mostrar todos os Planos"> <img src="images/icon/shortcut/home.png" alt="home" /><strong>Planos</strong> </a> </li>
  ...
  <div class="row-fluid"> 
    ...
    <div class="widget  span12 clearfix">
      ...
      <form  name="digitador" method="post" action="finaliza/finalizado_vitrine_produto_pessoa_fisica.php" />
        ...
        <div id="wizard" class="swMain">
          ...
          <div id="step-1" style=" padding-left:33%;">
           ...
           <option value="Virtine de Serviços - Pessoa Física" >Virtine de Serviços - Pessoa Física</option>
           <option value="Vitrine de Produtos - Pessoa Física" selected>Vitrine de Produtos - Pessoa Física</option>
