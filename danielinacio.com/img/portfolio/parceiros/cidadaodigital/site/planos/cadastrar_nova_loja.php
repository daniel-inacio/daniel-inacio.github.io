                            ...
                            <div class="widget  span12 clearfix">
                                ...
                                <div class="tab_container">
                                  ...
                                  <div id="tab1" class="tab_content"> 
                                    ...
                                    Por Favor preencha todos os campos obrigatórios
                                      ...
                                      <form  id="form1" name="form1" method="post" enctype="multipart/form-data" action="loja_cadastrada.php" />                                         
                                          ...
                                          <div>
                                  		 ...
                                  		 <div class="section">
                                                 <label><h4>Já possui uma loja virtual?</h4></label>
                                               </div>  
                                               <div class="section">  
                                               <div>
                                                    <div class="radiorounded">
                                                        <input type="radio" name="plano" id="radio-1" value="SIM" />
                                                        <label for="radio-1" title="SIM"></label>
                                                    </div>
                                                    <div class="radiorounded">
                                                        <input type="radio" name="plano" id="radio-2" value="NÃO" checked="checked" />
                                                        <label for="radio-2" title="NÃO"></label>
                                                    </div>
                                    ...
                                    <div>
                                    <label><h4>Digite um breve histórico que como deseja sua loja virtual:</h4></label> 
